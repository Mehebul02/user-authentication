  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white shadow-md rounded-xl">
      ...
      <form onSubmit={handleSignup} className="space-y-4">
        ...
        <button
          type="submit"
          className="w-full text-black bg-[#3bc4f6]  py-2 rounded-md hover:bg-blue-700 transition duration-200"
        >
          {
       ...
       <h1 className='mt-4 text-center space-x-1 '>You have an account?
                <Link to="/signin" className="text-indigo-600 hover:text-indigo-500">Sign In</Link>
              </h1>
    </div>
  );
};
